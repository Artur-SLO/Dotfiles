...
hl.config({
    background = {
        -- Tenta carregar o wallpaper atual, se falhar usa preto
        path = "~/.cache/current_wallpaper",
        color = background,
        -- Cor de fundo fallback (preto/azulado)
        -- Efeitos de Blur
        blur_size = 3,
        blur_passes = 2,
        noise = 0.0117,
...
hl.config({
    input-field = {
        ...
        outer_color = primary,
        -- Border color
        inner_color = surface_container_highest,
        -- Semi-transparent bg
